...
package com.chalilayang.flowyear.data.sources.task.local;
...
import com.chalilayang.flowyear.data.entities.Task;
import com.chalilayang.flowyear.data.sources.task.TasksDataSource;
...
public class TasksLocalDataSource implements TasksDataSource {
    ...
    public void getTasks(@NonNull LoadTasksCallback callback) {
        ...
        if (c != null && c.getCount() > 0) {
            while (c.moveToNext()) {
                String itemId = c.getString(c.getColumnIndexOrThrow(TasksPersistenceContract
                        .TaskEntry.COLUMN_NAME_ENTRY_ID));
                String title = c.getString(c.getColumnIndexOrThrow(TasksPersistenceContract
